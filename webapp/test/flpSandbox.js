		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#comesfsrapempskifsrap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comesfsrapempskifsrap-display": {
								"semanticObject": "comesfsrapempskifsrap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.esfsrap.empskifsrap",
									"url": sap.ui.require.toUrl("com/esfsrap/empskifsrap")
								}
							}
						}
					}
